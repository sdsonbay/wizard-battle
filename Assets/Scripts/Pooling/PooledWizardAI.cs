...
public class PooledWizardAI : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (spellPool == null)
        {
            spellPool = FindObjectOfType<SpellPool>();
        }
    ...
    public void SpawnSpell()
    {
        ...
        if (spellPool == null)
        {
            Debug.LogWarning("PooledWizardAI: SpellPool bulunamadı, spell atılamıyor!");
            return;
        }
        ...
        GameObject spell = spellPool.GetSpellFromPool(
        ...
        if (spell == null)
        {
            Debug.LogWarning($"PooledWizardAI: Pool'dan spell alınamadı! Wizard: {gameObject.name}, Pool Size: {spellPool.poolSize}, Active: {spellPool.activeSpellCount}");
        }
    }
